...
<html>
    ...
    <body>
        ...
        <div class="page-header">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1><i class="bi bi-person-badge-fill me-2"></i>Empleados</h1>
                        <p class="mb-0">Gestión de empleados del sistema</p>
                    </div>
        ...
        <div class="container">
            ...
            <!-- Action Buttons -->
            <div class="mb-3">
                <a href="${pageContext.request.contextPath}/EmpleadosControlador?accion=nuevo"
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-success">
                            <tr>
                                ...
                                <th><i class="bi bi-person me-1"></i>Apellidos</th>
                        ...
                        <tbody>
                            <c:forEach items="${empleados}" var="item">
                                <tr>
                                    <td><strong>${item.idEmpleado}</strong></td>
                                    <td>${item.apellidos}</td>
                                    <td>${item.nombre}</td>
                                    <td><span class="badge bg-info">${item.cargo}</span></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/EmpleadosControlador?accion=eliminar&idEmpleado=${item.idEmpleado}"
