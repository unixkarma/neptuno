...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-0">Gestión de categorías del sistema</p>
                    </div>
        ...
        <div class="container">
            ...
            <!-- Action Buttons -->
            <div class="mb-3">
                <a href="${pageContext.request.contextPath}/CategoriasControlador?accion=nuevo"
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th><i class="bi bi-tag me-1"></i>Nombre Categoría</th>
                        ...
                        <tbody>
                            <c:forEach items="${categorias}" var="item">
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary">${item.nombreCategoria}</span></td>
                                    <td>${item.descripcion}</td>
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/CategoriasControlador?accion=editar&idCategoria=${item.idCategoria}"
                                           class="btn btn-warning btn-sm me-1" title="Editar">
                                            <i class="bi bi-pencil-fill"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/CategoriasControlador?accion=eliminar&idCategoria=${item.idCategoria}"
