<%--
    ...
    Created on : Jan 22, 2026, 6:12:19 PM
    Author     : elliot
--%>
...
<html>
    ...
    <body>
        ...
        <div class="page-header">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1><i class="bi bi-people-fill me-2"></i>Clientes</h1>
                        <p class="mb-0">Gestión de clientes del sistema</p>
                    </div>
        ...
        <div class="container">
            ...
            <!-- Action Buttons -->
            <div class="mb-3">
                <a href="${pageContext.request.contextPath}/ClientesControlador?accion=nuevo"
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <c:forEach items="${clientes}" var="item">
                                <tr>
                                    <td><strong>${item.idCliente}</strong></td>
                                    <td>${item.nombreCompania}</td>
                                    <td>${item.nombreContacto}</td>
                                    <td><span class="badge bg-secondary">${item.cargoContacto}</span></td>
                                    <td>${item.ciudad}</td>
                                    <td>${item.pais}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/ClientesControlador?accion=eliminar&idCliente=${item.idCliente}"
